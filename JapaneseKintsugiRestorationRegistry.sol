...
contract JapaneseKintsugiRestorationRegistry {

    struct KintsugiTechnique {
        string region;        // Kyoto, Kanazawa, Tokyo, etc.
        string workshop;      // lacquer studios or restoration lineages
        string techniqueName; // crack filling, urushi bonding, gold dust finishing
        string materialType;  // urushi lacquer, gold powder, ceramic base
        string culturalNote;  // historical or cultural context
        string ritualUse;     // symbolic or traditional meaning
        address creator;
        uint256 likes;
        uint256 dislikes;
        uint256 createdAt;
    ...
    KintsugiTechnique[] public techniques;
    ...
    function voteTechnique(uint256 id, bool like) external {
        ...
        KintsugiTechnique storage t = techniques[id];
